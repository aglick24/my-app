    ...
    <div className='Work' id='Work'>
        <div className='Container'>
            ...
            <div className='Content'>
                <Card image={<FaIcons.FaGlobeAfrica className="Icon"/>}
                alt={'shindell'}
                ...
                content={<><p>I applied for and received Duke's Stanback Fellowship through the Nicholas School for the Environment in Summer 2021 (after sophomore year). I was paired with environmental non-profit RMI as an intern on their US Program, modeling state-level climate policy through their Energy Policy Simulator, working on calibrating the simulator, and analyzing the data coming from it.  We then used the results of the model to advise state government's on their climate action plans, including working through a series of workshops with the New Mexico state government.</p><p>I ended the summer with a personal project in which I explored a new method of estimating mortality due to fossil fuel-related air pollution using a database from the Center for Air, Climate and Energy Solutions, and RMI's own projections from the Energy Policy Simulator.</p><p>All data work and coding was done in Python using Pandas.</p></>}/>
                <Card image={duke}
                alt={'uta'}
